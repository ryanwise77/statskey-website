...
const de = {
  ...
  'lp-content': `
          ...
          <section>
            ...
            <p class="mb-3" data-birthday-privacy="true"><strong class="text-text-primary">Altersangaben und Geburtstag.</strong> Geburtsjahr und Geburtstagsangaben, die du für dein Profil angibst, sind private Kontodaten. Wir verwenden sie für eine altersgerechte Einrichtung, personalisierte Funktionen und einen Geburtstagsgruß in der App. Dein Geburtstag wird weder in deinem öffentlichen Profil noch in deinem Profil im Bereich Freunde angezeigt.</p>
            ...
            <p class="mb-3"><strong class="text-text-primary">Standortdaten.</strong> Wenn du die Standortdienste aktivierst, erfassen wir während der aktiven Workout-Aufzeichnung GPS-Daten, um Route, Distanz, Pace und Höhenmeter zu verfolgen. Ein Standortzugriff im Hintergrund erfolgt nur, während eine Workout-Sitzung läuft, und endet, wenn die Sitzung beendet oder pausiert wird. Unabhängig davon kann die App, wenn du die länderbezogene Lebensmittelsuche aktivierst, im Vordergrund deinen Standort und Apples Geokodierungsdienst verwenden, um dein Land zu bestimmen. Die Ernährungsdienste erhalten nur den Ländercode, nicht deine Koordinaten oder Adresse. Das für eine Lebensmittelsuche verwendete Land kann im jeweiligen Lebensmitteleintrag gespeichert bleiben. Wenn du die Option ausschaltest, wird der aktuelle Länderhinweis gelöscht; bestehende Lebensmitteleinträge bleiben unverändert.</p>
            <p class="mb-3" data-location-retirement="true">Die Live-Standortfreigabe wurde eingestellt. StatsKey nimmt keine neuen Standortaktualisierungen für diese Freigabefunktion mehr an und stellt zuvor geteilte Standorte Freunden nicht mehr zur Verfügung. Bereits gespeicherte letzte Standortpunkte, Freigabeeinstellungen und Daten zu freigebenden Geräten werden durch diese Änderung nicht automatisch gelöscht. Sie bleiben geschützte Kontodaten gemäß den Aufbewahrungsregeln in Abschnitt 9. Du kannst wie in Abschnitt 10 beschrieben Auskunft oder Löschung anfordern. Die GPS-Aufzeichnung von Workouts bleibt verfügbar.</p>
          ...
          <section>
            ...
            <p class="mb-3">Nach deiner ausdrücklichen Einwilligung kann StatsKey relevante Inhalte für Intelligence-Chat, Essensfoto-Analyse, Nährwertetiketten-Scans, Trainingspläne und Ernährungseinblicke an einen oder mehrere der folgenden KI-Verarbeiter senden, um einen privaten Suchindex zu erstellen oder eine Antwort zu berechnen.</p>
            <ul class="list-disc pl-5 space-y-2 mb-3">
              <li><strong class="text-text-primary">Google LLC</strong> – Gemini und Vertex AI. <a href="https://policies.google.com/privacy" class="text-accent hover:underline" target="_blank" rel="noopener">Datenschutzerklärung von Google</a>.</li>
              ...
              <li><strong class="text-text-primary">Perplexity AI, Inc.</strong> — Sonar-API zur Suche nach Nährwertquellen anhand relevanter Lebensmittelbeschreibungen, Portions- und Zutatenangaben, Nährwertnachweise und des optionalen Länderhinweises. <a href="https://docs.perplexity.ai/docs/resources/privacy-security" class="text-accent hover:underline" target="_blank" rel="noopener">Datenschutz und Sicherheit der Perplexity-API</a>.</li>
              <li><a href="https://platform.kimi.ai/docs/agreement/userprivacy" class="text-accent hover:underline" target="_blank" rel="noopener">Kimi — MOONSHOT AI PTE. LTD.</a></li>
            </ul>
            <p class="mb-3">Wenn du die Option aktivierst, kann auch der Ländercode zur Suche nach passenden Lebensmittelquellen zusammen mit diesen Suchangaben übermittelt werden. Dieser Ernährungshinweis enthält keine Koordinaten oder Adresse.</p>
            <p class="mb-3">Zu den Kategorien personenbezogener Inhalte, die wir an die oben genannten Anbieter übermitteln können, gehören: Nachrichten und Eingaben, die du in den KI-Chat tippst; Fotos, die du für die Essens- bzw. Nährwertetiketten-Analyse aufnimmst oder auswählst; Zusammenfassungen deiner Ernährungs-, Gewichts-, Flüssigkeits-, Nahrungsergänzungs- und Glukose-Protokolle; historische Glukosedaten und zugehörige Trends, sofern für deine Anfrage relevant; Zusammenfassungen deiner Workouts, Pace, Herzfrequenz und Trainingspläne; sowie grundlegende Profilfelder aus dem Onboarding (Name, biologisches Geschlecht, Gewicht, Größe, Ziele). Je nach Funktion und den von dir aktivierten Freigabekategorien können dazu auch auf dem Gerät extrahierte Texte aus Dokumenten gehören, die du ausdrücklich an eine Intelligence-Unterhaltung anhängst, bestätigte Blutuntersuchungswerte bei aktivierter Kategorie Blutuntersuchungen (Blood Panels) sowie kompakte Suchindex-Zusammenfassungen aus aktivierten Datensätzen.</p>
            <p class="mb-3">Bevor wir Inhalte zum ersten Mal an diese Verarbeiter übermitteln, zeigt die App einen In-App-Hinweis, der die Verarbeiter und die oben genannten Inhaltskategorien benennt und dich um deine Erlaubnis bittet. Du kannst diese Erlaubnis jederzeit unter <em>Einstellungen &rarr; Datenschutz &rarr; Intelligence-Funktionen</em> einsehen oder widerrufen. Ein Widerruf deaktiviert jede KI-gestützte Funktion der App, während der Rest der App voll funktionsfähig bleibt. Die bloße Annahme der Kontobedingungen aktiviert keine KI-Datenfreigabe.</p>
            <p class="mb-3" data-ai-index-disclosure="true">StatsKey speichert kompakte abgeleitete Suchindex-Zusammenfassungen in deinem Konto und kann sie aktualisieren, wenn sich aktivierte Datensätze ändern. Wenn du Intelligence deaktivierst, wird die Löschung dieses abgeleiteten Index angefordert; deine gespeicherten Quelldaten bleiben gemäß dieser Richtlinie verfügbar.</p>
            <ul class="list-disc pl-5 space-y-2">
              <li>Wir fügen KI-Inhalten nicht automatisch deine Kontokennungen oder Kontaktdaten hinzu. Die offengelegten Profilinformationen können deinen Namen enthalten, und Inhalte, die du teilst, können dich ebenfalls identifizieren.</li>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">KI-Anbieter (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi, Perplexity Sonar):</strong> KI-gestützte Essensanalyse, Nährwertschätzung, Erstellung von Trainingsplänen und Dialogfunktionen. Siehe Abschnitt 5 für die Links je Anbieter und den In-App-Berechtigungsablauf.</li>
...
const ja = {
  ...
  'lp-content': `
          ...
          <section>
            ...
            <p class="mb-3" data-birthday-privacy="true"><strong class="text-text-primary">年齢・誕生日の情報。</strong> プロフィールに提供する生まれた年や誕生日の情報は、非公開のアカウントデータです。これらは年齢に応じた設定、機能のパーソナライズ、アプリ内の誕生日のお祝いメッセージに使用します。誕生日を公開プロフィールや「フレンド」のプロフィールに表示することはありません。</p>
            ...
            <p class="mb-3"><strong class="text-text-primary">位置情報データ。</strong> 位置情報サービスを有効にした場合、当社はワークアウトの記録中にGPSデータを収集し、ルート、距離、ペース、標高を記録します。バックグラウンドでの位置情報アクセスは、ワークアウトのセッション進行中にのみ行われ、セッションが終了または一時停止されると停止します。これとは別に、国に応じた食品検索を有効にすると、アプリはフォアグラウンドで位置情報を取得し、Appleのジオコーディングサービスを使って国を判定することがあります。栄養情報の処理サービスに送信されるのは国コードのみで、座標や住所は送信されません。食品検索に使用した国は、その食品の記録に保存されることがあります。この設定をオフにすると現在の国のヒントは消去されますが、既存の食品記録は変更されません。</p>
            <p class="mb-3" data-location-retirement="true">現在地のライブ共有は終了しました。StatsKeyはライブ共有用の位置情報の更新を受け付けず、以前共有された位置情報を友人に提供することもありません。保存済みの最新の位置情報、共有設定、共有に使用したデバイスの記録は、この変更によって自動的に削除されるものではありません。これらは第9項の保存方針に従って保護されるアカウントデータとして保持され、第10項の手続きによりアクセスや削除を請求できます。GPSによるワークアウトの記録は引き続き利用できます。</p>
          ...
          <section>
            ...
            <p class="mb-3">StatsKeyは、お客様の明示的な許可を得た後、Intelligenceチャット、食事写真分析、栄養ラベルのスキャン、トレーニングプラン、栄養インサイトに関連するコンテンツを、以下の1つ以上の第三者AIプロセッサに送信し、非公開の検索インデックスを作成したり応答を生成したりする場合があります。</p>
            <ul class="list-disc pl-5 space-y-2 mb-3">
              <li><strong class="text-text-primary">Google LLC</strong> — GeminiおよびVertex AI。<a href="https://policies.google.com/privacy" class="text-accent hover:underline" target="_blank" rel="noopener">Googleプライバシーポリシー</a>。</li>
              ...
              <li><strong class="text-text-primary">Perplexity AI, Inc.</strong> — 関連する食品の説明、分量や原材料の情報、栄養情報の根拠、任意の国のヒントを使い、栄養情報の出典を検索するSonar API。 <a href="https://docs.perplexity.ai/docs/resources/privacy-security" class="text-accent hover:underline" target="_blank" rel="noopener">Perplexity APIのプライバシーとセキュリティ</a>.</li>
              <li><a href="https://platform.kimi.ai/docs/agreement/userprivacy" class="text-accent hover:underline" target="_blank" rel="noopener">Kimi — MOONSHOT AI PTE. LTD.</a></li>
            </ul>
            <p class="mb-3">この機能を有効にした場合、関連する食品の出典を探すための国コードも、食品検索の情報とともに送信されることがあります。この栄養情報用のヒントには座標や住所は含まれません。</p>
            <p class="mb-3">上記のプロバイダーに送信する可能性のある個人的なコンテンツのカテゴリーには、次のものが含まれます: AIチャットに入力したメッセージやプロンプト、食事／栄養ラベルの分析のために撮影または選択した写真、栄養・体重・水分・サプリメント・グルコースの記録の要約、リクエストに関連する場合の過去の血糖記録および関連する傾向、ワークアウト・ペース・心拍数・トレーニングプランの要約、ならびにオンボーディングで入力した基本的なプロフィール項目（氏名、生物学的性別、体重、身長、目標）。利用する機能と有効にした共有カテゴリーに応じて、Intelligenceの会話に明示的に添付した文書から端末上で抽出したテキスト、血液検査（Blood Panels）カテゴリーを有効にした場合の確認済みの血液検査値、有効にした記録から作成した簡潔な検索インデックスの要約も含まれる場合があります。</p>
            <p class="mb-3">これらのプロセッサに初めてコンテンツを送信する前に、アプリはプロセッサ名と上記のコンテンツのカテゴリーを示すアプリ内の開示を表示し、許可を求めます。この許可は <em>設定 &rarr; プライバシー &rarr; Intelligence機能</em> からいつでも確認または取り消すことができます。許可を取り消すと、アプリ内のすべてのAI機能が無効になりますが、アプリのその他の部分は引き続き完全に機能します。アカウントの規約への同意だけでは、AIとのデータ共有は有効になりません。</p>
            <p class="mb-3" data-ai-index-disclosure="true">StatsKeyは、記録から作成した簡潔な検索インデックスの要約をアカウントに保存し、有効にした記録が変更されると更新する場合があります。Intelligenceを無効にすると、この派生インデックスの削除が要求されます。保存済みの元の記録は、本ポリシーに従って引き続き利用できます。</p>
            <ul class="list-disc pl-5 space-y-2">
              <li>当社は、AIに送信するコンテンツにアカウント識別子や連絡先情報を自動的に追加しません。上記で開示したプロフィール情報には氏名が含まれる場合があり、お客様が共有を選択したコンテンツによって、お客様が特定される場合もあります。</li>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">AIプロバイダー（Google Gemini / Vertex AI、Anthropic Claude、OpenAI ChatGPT、xAI Grok, Kimi、Perplexity Sonar）:</strong> AIによる食事分析、栄養推定、トレーニングプラン生成、対話機能。プロバイダーごとのリンクとアプリ内の許可フローについては第5条をご覧ください。</li>
...
const pt = {
  ...
  'lp-date':
    'Data de vigência: 11 de setembro de 2026<span class="block mt-2 italic">Esta tradução para o português é apenas informativa. Em caso de divergência, prevalece a versão original em inglês.</span>',
  'lp-content': `
          <section>
          ...
          <section>
            ...
            <p class="mb-3" data-birthday-privacy="true"><strong class="text-text-primary">Idade e Aniversário.</strong> O ano de nascimento e os dados de aniversário que você fornece para seu perfil são dados privados da conta. Nós os usamos para configurar uma experiência adequada à idade, personalizar recursos e mostrar uma mensagem de aniversário no aplicativo. Não exibimos seu aniversário no perfil público nem no perfil da seção Amigos.</p>
            ...
            <p class="mb-3"><strong class="text-text-primary">Dados de localização.</strong> Se você ativar os serviços de localização, coletamos dados de GPS durante o registro ativo de um treino para acompanhar rota, distância, ritmo e elevação. O acesso à localização em segundo plano ocorre apenas enquanto uma sessão de treino está em andamento e cessa quando a sessão termina ou é pausada. Separadamente, se você ativar a busca de alimentos por país, o app poderá obter a localização em primeiro plano e usar o serviço de geocodificação da Apple para determinar seu país. Os serviços de nutrição recebem apenas o código do país, não suas coordenadas ou endereço. O país usado em uma busca pode permanecer no registro desse alimento. Desativar a opção limpa a indicação atual de país sem alterar os registros de alimentos existentes.</p>
            <p class="mb-3" data-location-retirement="true">O compartilhamento de localização ao vivo foi encerrado. O StatsKey não aceita mais atualizações de localização para esse recurso nem permite que amigos acessem localizações compartilhadas anteriormente. Os últimos pontos de localização, as preferências de compartilhamento e os registros dos dispositivos usados para compartilhar que tenham sido armazenados não são apagados automaticamente por essa mudança. Eles continuam sendo dados protegidos da conta, sujeitos à política de retenção da Seção 9; você pode solicitar acesso ou exclusão conforme a Seção 10. A gravação de treinos com GPS continua disponível.</p>
          ...
          <section>
            ...
            <p class="mb-3">Após sua permissão explícita, o StatsKey pode enviar conteúdo relevante para o chat do Intelligence, análise de fotos de alimentos, leitura de rótulos nutricionais, planos de treino e insights de nutrição a um ou mais dos processadores de IA abaixo para criar um índice de busca privado ou calcular uma resposta.</p>
            <ul class="list-disc pl-5 space-y-2 mb-3">
              <li><strong class="text-text-primary">Google LLC</strong> — Gemini e Vertex AI. <a href="https://policies.google.com/privacy" class="text-accent hover:underline" target="_blank" rel="noopener">Política de Privacidade do Google</a>.</li>
              ...
              <li><strong class="text-text-primary">Perplexity AI, Inc.</strong> — API Sonar para buscar fontes de informações nutricionais, usando descrições relevantes dos alimentos, detalhes de porções e ingredientes, evidências nutricionais e a indicação opcional de país. <a href="https://docs.perplexity.ai/docs/resources/privacy-security" class="text-accent hover:underline" target="_blank" rel="noopener">Privacidade e segurança da API Perplexity</a>.</li>
              <li><a href="https://platform.kimi.ai/docs/agreement/userprivacy" class="text-accent hover:underline" target="_blank" rel="noopener">Kimi — MOONSHOT AI PTE. LTD.</a></li>
            </ul>
            <p class="mb-3">Se você ativar a opção, o código do país usado para encontrar fontes relevantes de alimentos também poderá ser enviado com os detalhes dessa busca. Essa indicação para a busca nutricional não inclui coordenadas nem endereço.</p>
            <p class="mb-3">As categorias de conteúdo pessoal que podemos transmitir aos provedores acima incluem: mensagens e prompts que você digita no chat de IA; fotos que você captura ou seleciona para análise de alimentos / rótulos nutricionais; resumos dos seus registros de nutrição, peso, hidratação, suplementos e glicose; registros históricos de glicose e tendências relacionadas quando relevantes para sua solicitação; resumos dos seus treinos, ritmo, frequência cardíaca e plano de treino; e campos básicos de perfil que você forneceu na configuração inicial (nome, sexo biológico, peso, altura, metas). Dependendo do recurso e das categorias de compartilhamento que você ativar, isso também pode incluir texto extraído no dispositivo de documentos que você anexar explicitamente a uma conversa do Intelligence, valores confirmados de exames de sangue quando você ativar a categoria Exames de sangue (Blood Panels), e resumos compactos do índice de busca derivados dos registros habilitados.</p>
            <p class="mb-3">Antes de transmitirmos qualquer conteúdo a esses processadores pela primeira vez, o app apresenta um aviso no aplicativo que identifica os processadores e as categorias de conteúdo acima e solicita sua permissão. Você pode revisar ou revogar essa permissão a qualquer momento em <em>Ajustes &rarr; Privacidade &rarr; Recursos do Intelligence</em>. Revogar a permissão desativa todos os recursos com IA do aplicativo, mantendo o restante do app totalmente funcional. Aceitar apenas os termos da conta não ativa o compartilhamento de dados com IA.</p>
            <p class="mb-3" data-ai-index-disclosure="true">O StatsKey armazena resumos compactos e derivados do índice de busca na sua conta e pode atualizá-los quando os registros habilitados mudarem. Desativar o Intelligence solicita a exclusão desse índice derivado; seus registros originais salvos continuam disponíveis conforme esta política.</p>
            <ul class="list-disc pl-5 space-y-2">
              <li>Não adicionamos automaticamente seus identificadores de conta ou dados de contato ao conteúdo enviado à IA. As informações de perfil descritas acima podem incluir seu nome, e o conteúdo que você escolhe compartilhar pode identificar você.</li>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">Provedores de IA (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi, Perplexity Sonar):</strong> Análise de alimentos com IA, estimativa nutricional, geração de planos de treino e recursos conversacionais. Consulte a Seção 5 para os links por provedor e o fluxo de permissão no aplicativo.</li>
...
const es = {
  ...
  'lp-content': `
          ...
          <section>
            ...
            <p class="mb-3" data-birthday-privacy="true"><strong class="text-text-primary">Edad y cumpleaños.</strong> El año de nacimiento y los datos de cumpleaños que proporcionas para tu perfil son datos privados de tu cuenta. Los usamos para configurar una experiencia adecuada a tu edad, personalizar funciones y mostrar una felicitación de cumpleaños en la app. No mostramos tu cumpleaños en tu perfil público ni en el perfil de la sección Amigos.</p>
            ...
            <p class="mb-3"><strong class="text-text-primary">Datos de ubicación.</strong> Si activas los servicios de ubicación, recopilamos datos de GPS durante el registro activo de un entrenamiento para seguir la ruta, la distancia, el ritmo y el desnivel. El acceso a la ubicación en segundo plano solo se produce mientras una sesión de entrenamiento está en curso y cesa cuando la sesión finaliza o se pausa. Por separado, si activas la búsqueda de alimentos por país, la app puede obtener la ubicación en primer plano y usar el servicio de geocodificación de Apple para determinar tu país. Los servicios de nutrición reciben solo el código del país, no tus coordenadas ni tu dirección. El país utilizado en una búsqueda puede conservarse en el registro de ese alimento. Desactivar la opción borra la indicación actual del país sin modificar los registros de alimentos existentes.</p>
            <p class="mb-3" data-location-retirement="true">La función de compartir ubicación en tiempo real se ha retirado. StatsKey ya no acepta actualizaciones de ubicación para esta función ni permite que tus amigos accedan a ubicaciones compartidas anteriormente. Los últimos puntos de ubicación, las preferencias de uso compartido y los registros de dispositivos que se hayan guardado no se eliminan automáticamente con este cambio. Siguen siendo datos protegidos de tu cuenta sujetos a la política de conservación de la Sección 9; puedes solicitar acceso o eliminación según la Sección 10. El registro de entrenamientos por GPS sigue disponible.</p>
          ...
          <section>
            ...
            <p class="mb-3">Tras tu permiso explícito, StatsKey puede enviar contenido relevante para el chat de Intelligence, el análisis de fotos de alimentos, el escaneo de etiquetas nutricionales, los planes de entrenamiento y la información nutricional a uno o más de los procesadores de IA siguientes para crear un índice de búsqueda privado o calcular una respuesta.</p>
            <ul class="list-disc pl-5 space-y-2 mb-3">
              <li><strong class="text-text-primary">Google LLC</strong> — Gemini y Vertex AI. <a href="https://policies.google.com/privacy" class="text-accent hover:underline" target="_blank" rel="noopener">Política de Privacidad de Google</a>.</li>
              ...
              <li><strong class="text-text-primary">Perplexity AI, Inc.</strong> — API Sonar para buscar fuentes de información nutricional, utilizando descripciones relevantes de alimentos, detalles de porciones e ingredientes, evidencia nutricional y la indicación opcional del país. <a href="https://docs.perplexity.ai/docs/resources/privacy-security" class="text-accent hover:underline" target="_blank" rel="noopener">Privacidad y seguridad de la API Perplexity</a>.</li>
              <li><a href="https://platform.kimi.ai/docs/agreement/userprivacy" class="text-accent hover:underline" target="_blank" rel="noopener">Kimi — MOONSHOT AI PTE. LTD.</a></li>
            </ul>
            <p class="mb-3">Si activas la opción, el código del país utilizado para encontrar fuentes relevantes de alimentos también puede enviarse con los detalles de esa búsqueda. Esta indicación para la búsqueda nutricional no incluye coordenadas ni dirección.</p>
            <p class="mb-3">Las categorías de contenido personal que podemos transmitir a los proveedores anteriores incluyen: mensajes e indicaciones que escribes en el chat de IA; fotos que capturas o seleccionas para el análisis de alimentos o etiquetas nutricionales; resúmenes de tus registros de nutrición, peso, hidratación, suplementos y glucosa; registros históricos de glucosa y tendencias relacionadas cuando son relevantes para tu solicitud; resúmenes de tus entrenamientos, ritmo, frecuencia cardíaca y plan de entrenamiento; y campos básicos de perfil que proporcionaste durante la configuración inicial (nombre, sexo biológico, peso, altura, objetivos). Según la función y las categorías de uso compartido que actives, también puede incluir texto extraído en el dispositivo de documentos que adjuntes expresamente a una conversación de Intelligence, valores confirmados de análisis de sangre cuando actives la categoría Análisis de sangre (Blood Panels), y resúmenes compactos del índice de búsqueda derivados de los registros habilitados.</p>
            <p class="mb-3">Antes de transmitir cualquier contenido a estos procesadores por primera vez, la app muestra un aviso dentro de la aplicación que nombra a los procesadores y las categorías de contenido anteriores y te pide permiso. Puedes revisar o revocar este permiso en cualquier momento desde <em>Ajustes &rarr; Privacidad &rarr; Funciones de Intelligence</em>. Revocar el permiso desactiva todas las funciones con IA de la app, manteniendo el resto de la aplicación plenamente funcional. Aceptar los términos de la cuenta por sí solo no habilita el uso compartido de datos con IA.</p>
            <p class="mb-3" data-ai-index-disclosure="true">StatsKey almacena resúmenes compactos del índice de búsqueda derivados de sus registros en tu cuenta y puede actualizarlos cuando cambien los registros habilitados. Al desactivar Intelligence, se solicita la eliminación de ese índice derivado; los registros originales guardados siguen disponibles conforme a esta política.</p>
            <ul class="list-disc pl-5 space-y-2">
              <li>No añadimos automáticamente tus identificadores de cuenta ni tus datos de contacto al contenido enviado a la IA. La información de perfil indicada anteriormente puede incluir tu nombre, y el contenido que decides compartir puede identificarte.</li>
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">Proveedores de IA (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi, Perplexity Sonar):</strong> Análisis de alimentos con IA, estimación nutricional, generación de planes de entrenamiento y funciones conversacionales. Consulta la Sección 5 para ver los enlaces de cada proveedor y el flujo de permisos dentro de la app.</li>
