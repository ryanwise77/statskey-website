  ...
  'lp-content': `
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">KI-Anbieter (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi):</strong> KI-gestützte Essensanalyse, Nährwertschätzung, Erstellung von Trainingsplänen und Dialogfunktionen. Siehe Abschnitt 5 für die Links je Anbieter und den In-App-Berechtigungsablauf.</li>
  ...
  'lp-content': `
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">AIプロバイダー（Google Gemini / Vertex AI、Anthropic Claude、OpenAI ChatGPT、xAI Grok, Kimi）:</strong> AIによる食事分析、栄養推定、トレーニングプラン生成、対話機能。プロバイダーごとのリンクとアプリ内の許可フローについては第5条をご覧ください。</li>
  ...
  'lp-content': `
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">Provedores de IA (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi):</strong> Análise de alimentos com IA, estimativa nutricional, geração de planos de treino e recursos conversacionais. Consulte a Seção 5 para os links por provedor e o fluxo de permissão no aplicativo.</li>
  ...
  'lp-content': `
          ...
          <section>
            ...
            <ul class="list-disc pl-5 space-y-2">
              ...
              <li><strong class="text-text-primary">Proveedores de IA (Google Gemini / Vertex AI, Anthropic Claude, OpenAI ChatGPT, xAI Grok, Kimi):</strong> Análisis de alimentos con IA, estimación nutricional, generación de planes de entrenamiento y funciones conversacionales. Consulta la Sección 5 para ver los enlaces de cada proveedor y el flujo de permisos dentro de la app.</li>
