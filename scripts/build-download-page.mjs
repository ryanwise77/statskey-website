  ...
  const campaignHero = `<section class="campaign-product-hero" id="welcome" data-analytics-section="welcome" aria-labelledby="campaign-title">
        <div class="page-shell campaign-product-grid">
          ...
          <figure class="campaign-product-visual">
            <div class="campaign-product-stage">
              <div class="campaign-stage-label"><span>STATSKEY</span><span>YOUR DAY, IN VIEW</span></div>
              <div class="campaign-phone-pair">
                <img class="campaign-phone campaign-phone--nutrition" src="/statskey-app/record-nutrition.png" width="471" height="1024" alt="StatsKey nutrition screen with meal records, daily nutrients, and water" fetchpriority="high" decoding="async">
                <img class="campaign-phone campaign-phone--activity" src="/statskey-app/activity-may11.png" width="471" height="1024" alt="StatsKey activity screen with workouts and training" decoding="async">
              </div>
              <p class="campaign-stage-caption">Small steps. A clearer picture.</p>
            </div>
            <figcaption>iPhone app previews. Features and appearance vary by platform and version.</figcaption>
          </figure>
        </div>
