...
const REQUIRED_RELEASE_SOURCE_FILES = Object.freeze([
  ...
  'public/downloads/statskey/capabilities.json',
  ...
  'desktop/fleet-auth-runtime.cjs',
  'desktop/fleet-pairing-runtime.cjs',
  'desktop/fleet-identity-store.cjs',
  'desktop/fleet-node-client.cjs',
  'desktop/fleet-node-supervisor.cjs',
  'desktop/fleet-artifact-uploader.cjs',
  'desktop/fleet-worker-adapters.cjs',
  'desktop/remote-session-runtime.cjs',
  'desktop/remote-session-capture-preload.cjs',
  'desktop/remote-session-capture.html',
  'desktop/windows-process-owner.ps1',
  'desktop/prepare-node-pty.cjs',
  'desktop/offline.html',
  'desktop/publish-update.cjs',
  'desktop/prepare-update.cjs',
  'desktop/prepare-update-runtime.cjs',
  'desktop/ship-mac-update.cjs',
  'desktop/mac-release-runtime.cjs',
  'desktop/public-release-boundary.cjs',
  ...
  'desktop/linux-release-runtime.cjs',
  'desktop/ubuntu-container-smoke.sh',
